cc.Class({
  ...
  to_gift(e) {
    e.stopPropagation();
    const oauth2_url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6d4c967a36137d82" +
      "&redirect_uri=" + encodeURI("http://tongan-gov.jihoukeji.vip/gift.html") +
